...
class MainMenuState extends MusicBeatState
{
	...
	var versionTxt:String = ' - CoolSwag';
	...
	override function create()
	{
		...
		{
			menuItems.createItem(null, null, "kickstarter", selectDonate, false);
		} else {
			menuItems.createItem(null, null, "donate", selectDonate, false);
		}
		...
		var versionShit:FlxText = new FlxText(5, FlxG.height - 18, 0, "Space Engine v" + Application.current.meta.get('version') + versionTxt, 12);
