...
var displayDiff:String = diffs[storyDifficulty];

var watermarkString:String = SONG.song + " - " + displayDiff + " | Space Engine 1.0 - CoolSwag";

watermarkTxt = new FlxText(10, FlxG.height - 24, 0, watermarkString.toUpperCase(), 16);
watermarkTxt.setFormat("assets/fonts/vcr.ttf", 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
...
add(watermarkTxt);
	...
	timeTxt = new FlxText(0, 8, FlxG.width, "00:00");
timeTxt.setFormat(Paths.font("vcr.ttf"), 24, FlxColor.WHITE, CENTER);
...
var timeLeft:Int = Std.int((FlxG.sound.music.length - Conductor.songPosition) / 1000);
var minutes:Int = Std.int(timeLeft / 60);
var seconds:Int = timeLeft % 60;

timeTxt.text = StringTools.lpad(Std.string(minutes), "0", 2)
    + ":"
